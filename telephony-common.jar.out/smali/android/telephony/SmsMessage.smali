...
.method public static getDeliveryPdu(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z[BI)Landroid/telephony/SmsMessage$DeliveryPdu;
    .locals 8
    .parameter "scAddress"
    ...
    invoke-virtual {v0, p5}, Landroid/telephony/MSimTelephonyManager;->getCurrentPhoneType(I)I
    ...
    .line 816
    invoke-static/range {v0 .. v5}, Lcom/android/internal/telephony/cdma/SmsMessage;->getDeliveryPdu(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZLcom/android/internal/telephony/SmsHeader;[B)Lcom/android/internal/telephony/cdma/SmsMessage$DeliveryPdu;

    move-result-object v7

    .line 823
    .local v7, spb:Lcom/android/internal/telephony/SmsMessageBase$DeliveryPduBase;
    :goto_1
    new-instance v0, Landroid/telephony/SmsMessage$DeliveryPdu;

    invoke-direct {v0, v7}, Landroid/telephony/SmsMessage$DeliveryPdu;-><init>(Lcom/android/internal/telephony/SmsMessageBase$DeliveryPduBase;)V

    return-object v0

    .line 811
    .end local v6           #activePhone:I
    .end local v7           #spb:Lcom/android/internal/telephony/SmsMessageBase$DeliveryPduBase;
    :cond_0
    invoke-static {}, Landroid/telephony/TelephonyManager;->getDefault()Landroid/telephony/TelephonyManager;
    ...
    .restart local v6       #activePhone:I
    :cond_1
    move-object v0, p0
    ...
    .line 819
    invoke-static/range {v0 .. v5}, Lcom/android/internal/telephony/gsm/SmsMessage;->getDeliveryPdu(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z[B[B)Lcom/android/internal/telephony/gsm/SmsMessage$DeliveryPdu;

    move-result-object v7

    .restart local v7       #spb:Lcom/android/internal/telephony/SmsMessageBase$DeliveryPduBase;
    goto :goto_1
.end method
...
.method public static getSubmitPdu(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZJI)Landroid/telephony/SmsMessage$SubmitPdu;
    .locals 8
    .parameter "scAddress"
    .parameter "destinationAddress"
    .parameter "message"
    ...
    .prologue
    .line 858
    invoke-static {p6}, Landroid/telephony/SmsMessage;->isCdmaVoice(I)Z
    ...
    invoke-static/range {v0 .. v6}, Lcom/android/internal/telephony/cdma/SmsMessage;->getSubmitPdu(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZLcom/android/internal/telephony/SmsHeader;J)Lcom/android/internal/telephony/cdma/SmsMessage$SubmitPdu;
    ...
    :cond_0
    invoke-static/range {p0 .. p5}, Lcom/android/internal/telephony/gsm/SmsMessage;->getSubmitPdu(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZJ)Lcom/android/internal/telephony/gsm/SmsMessage$SubmitPdu;
...
.method public static getSubmitPdu(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z[BI)Landroid/telephony/SmsMessage$SubmitPdu;
    ...
    .line 496
    invoke-static/range {v0 .. v5}, Lcom/android/internal/telephony/gsm/SmsMessage;->getSubmitPdu(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z[B[B)Lcom/android/internal/telephony/gsm/SmsMessage$SubmitPdu;
...
.method public getRecipientAddress()Ljava/lang/String;
    ...
    const-string v1, "mWrappedSmsMessage = null"
