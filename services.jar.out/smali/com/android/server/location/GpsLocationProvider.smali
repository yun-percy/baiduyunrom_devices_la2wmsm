...
.method public constructor <init>(Landroid/content/Context;Landroid/location/ILocationManager;Landroid/os/Looper;)V
    ...
    iput-object v10, p0, Lcom/android/server/location/GpsLocationProvider;->mLock:Ljava/lang/Object;
    ...
    iput-wide v10, p0, Lcom/android/server/location/GpsLocationProvider;->mStatusUpdateTime:J
    ...
    iput v10, p0, Lcom/android/server/location/GpsLocationProvider;->mFixInterval:I
    ...
    iput-object v10, p0, Lcom/android/server/location/GpsLocationProvider;->mLocation:Landroid/location/Location;
    ...
    iput-object v10, p0, Lcom/android/server/location/GpsLocationProvider;->mLocationExtras:Landroid/os/Bundle;
    ...
    iput-object v10, p0, Lcom/android/server/location/GpsLocationProvider;->mListeners:Ljava/util/ArrayList;
    ...
    iput-object v10, p0, Lcom/android/server/location/GpsLocationProvider;->mClientSource:Landroid/os/WorkSource;

    .line 369
    new-instance v10, Lcom/android/server/location/GpsLocationProvider$1;

    invoke-direct {v10, p0}, Lcom/android/server/location/GpsLocationProvider$1;-><init>(Lcom/android/server/location/GpsLocationProvider;)V

    iput-object v10, p0, Lcom/android/server/location/GpsLocationProvider;->mGpsStatusProvider:Landroid/location/IGpsStatusProvider;

    .line 426
    new-instance v10, Lcom/android/server/location/GpsLocationProvider$2;

    invoke-direct {v10, p0}, Lcom/android/server/location/GpsLocationProvider$2;-><init>(Lcom/android/server/location/GpsLocationProvider;)V

    iput-object v10, p0, Lcom/android/server/location/GpsLocationProvider;->mBroadcastReciever:Landroid/content/BroadcastReceiver;

    .line 1143
    new-instance v10, Lcom/android/server/location/GpsLocationProvider$6;

    invoke-direct {v10, p0}, Lcom/android/server/location/GpsLocationProvider$6;-><init>(Lcom/android/server/location/GpsLocationProvider;)V

    iput-object v10, p0, Lcom/android/server/location/GpsLocationProvider;->mGpsGeofenceBinder:Landroid/location/IGpsGeofenceHardware;

    .line 1695
    new-instance v10, Lcom/android/server/location/GpsLocationProvider$7;

    invoke-direct {v10, p0}, Lcom/android/server/location/GpsLocationProvider$7;-><init>(Lcom/android/server/location/GpsLocationProvider;)V

    iput-object v10, p0, Lcom/android/server/location/GpsLocationProvider;->mNetInitiatedListener:Landroid/location/INetInitiatedListener;
    ...
    iput-object v10, p0, Lcom/android/server/location/GpsLocationProvider;->mSvs:[I
    ...
    iput-object v10, p0, Lcom/android/server/location/GpsLocationProvider;->mSnrs:[F
    ...
    iput-object v10, p0, Lcom/android/server/location/GpsLocationProvider;->mSvElevations:[F
    ...
    iput-object v10, p0, Lcom/android/server/location/GpsLocationProvider;->mSvAzimuths:[F
    ...
    iput-object v10, p0, Lcom/android/server/location/GpsLocationProvider;->mSvMasks:[I
    ...
    iput-object v10, p0, Lcom/android/server/location/GpsLocationProvider;->mNmeaBuffer:[B
    ...
    iput-object v10, p0, Lcom/android/server/location/GpsLocationProvider;->mNtpTime:Landroid/util/NtpTrustedTime;
    ...
    .line 482
    new-instance v10, Lcom/android/internal/location/GpsNetInitiatedHandler;

    invoke-direct {v10, p1}, Lcom/android/internal/location/GpsNetInitiatedHandler;-><init>(Landroid/content/Context;)V

    iput-object v10, p0, Lcom/android/server/location/GpsLocationProvider;->mNIHandler:Lcom/android/internal/location/GpsNetInitiatedHandler;
    ...
    invoke-virtual {v10, v11}, Landroid/location/Location;->setExtras(Landroid/os/Bundle;)V
    ...
    iput-object v10, p0, Lcom/android/server/location/GpsLocationProvider;->mWakeLock:Landroid/os/PowerManager$WakeLock;

    .line 489
    iget-object v10, p0, Lcom/android/server/location/GpsLocationProvider;->mWakeLock:Landroid/os/PowerManager$WakeLock;
    ...
    iput-object v10, p0, Lcom/android/server/location/GpsLocationProvider;->mAlarmManager:Landroid/app/AlarmManager;
    ...
    const-string v13, "com.android.internal.location.ALARM_WAKEUP"
    ...
    iput-object v10, p0, Lcom/android/server/location/GpsLocationProvider;->mWakeupIntent:Landroid/app/PendingIntent;
    ...
    const-string v13, "com.android.internal.location.ALARM_TIMEOUT"
    ...
    iput-object v10, p0, Lcom/android/server/location/GpsLocationProvider;->mTimeoutIntent:Landroid/app/PendingIntent;
    ...
    iput-object v10, p0, Lcom/android/server/location/GpsLocationProvider;->mConnMgr:Landroid/net/ConnectivityManager;
    ...
    iput-object v10, p0, Lcom/android/server/location/GpsLocationProvider;->mAppOpsService:Lcom/android/internal/app/IAppOpsService;
    ...
    iput-object v10, p0, Lcom/android/server/location/GpsLocationProvider;->mBatteryStats:Lcom/android/internal/app/IBatteryStats;
    ...
    iput-object v10, p0, Lcom/android/server/location/GpsLocationProvider;->mProperties:Ljava/util/Properties;
    ...
    .line 545
    .local v3, objContentResolver:Landroid/content/ContentResolver;
    const-string v10, "assisted_gps_position_mode"

    invoke-static {v3, v10}, Landroid/provider/Settings$Global;->getString(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v6

    .line 548
    .local v6, prefAGpsType:Ljava/lang/String;
    if-nez v6, :cond_4
    ...
    .line 559
    .local v7, prefAGpsTypeInt:I
    :goto_3
    iput v7, p0, Lcom/android/server/location/GpsLocationProvider;->mPrefAGpsMode:I

    .line 560
    const-string v10, "assisted_gps_network"

    invoke-static {v3, v10}, Landroid/provider/Settings$Global;->getString(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v10

    iput-object v10, p0, Lcom/android/server/location/GpsLocationProvider;->mPrefAGpsNetworkType:Ljava/lang/String;

    .line 564
    new-instance v10, Lcom/android/server/location/GpsLocationProvider$ProviderHandler;

    move-object/from16 v0, p3

    invoke-direct {v10, p0, v0}, Lcom/android/server/location/GpsLocationProvider$ProviderHandler;-><init>(Lcom/android/server/location/GpsLocationProvider;Landroid/os/Looper;)V

    iput-object v10, p0, Lcom/android/server/location/GpsLocationProvider;->mHandler:Landroid/os/Handler;
    ...
    .line 513
    .end local v3           #objContentResolver:Landroid/content/ContentResolver;
    .end local v6           #prefAGpsType:Ljava/lang/String;
    .end local v7           #prefAGpsTypeInt:I
    ...
    const-string v11, "Could not open GPS configuration file /etc/gps.conf"
    ...
    .end local v4           #portString:Ljava/lang/String;
    .end local v9           #stream:Ljava/io/FileInputStream;
    .restart local v3       #objContentResolver:Landroid/content/ContentResolver;
    .restart local v6       #prefAGpsType:Ljava/lang/String;
    :cond_4
    ...
    .restart local v7       #prefAGpsTypeInt:I
    goto :goto_3
