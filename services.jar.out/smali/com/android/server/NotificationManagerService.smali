...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/NotificationManagerService$Status;
    }
.end annotation
...
# instance fields
.field private final MISS_CALL_NOTIFY_ID:I

.field private final NEW_MMS_NOTIFY_ID:I

.field private final STATE_IDLE:I

.field private final STATE_INFO:I

.field private final STATE_MISSCALL:I
...
.field private mYepLedNotification:Lcom/android/server/NotificationManagerService$NotificationRecord;

.field private mYepLedStatus:Lcom/android/server/NotificationManagerService$Status;

.field private mYepLights:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList",
            "<",
...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/StatusBarManagerService;Lcom/android/server/LightsService;)V
    ...
    iput-object v4, p0, Lcom/android/server/NotificationManagerService;->mYepLights:Ljava/util/ArrayList;

    .line 194
    iput v5, p0, Lcom/android/server/NotificationManagerService;->MISS_CALL_NOTIFY_ID:I

    .line 195
    const/16 v4, 0x7b

    iput v4, p0, Lcom/android/server/NotificationManagerService;->NEW_MMS_NOTIFY_ID:I

    .line 196
    iput v7, p0, Lcom/android/server/NotificationManagerService;->STATE_IDLE:I

    .line 197
    iput v5, p0, Lcom/android/server/NotificationManagerService;->STATE_INFO:I

    .line 198
    const/4 v4, 0x2

    iput v4, p0, Lcom/android/server/NotificationManagerService;->STATE_MISSCALL:I

    .line 200
    const-string v4, "true"

    const-string v5, "ro.doublecolor.yusunled"
    ...
    iput-boolean v4, p0, Lcom/android/server/NotificationManagerService;->mIsYepLed:Z

    .line 207
    sget-object v4, Lcom/android/server/NotificationManagerService$Status;->STATE_IDLE:Lcom/android/server/NotificationManagerService$Status;

    iput-object v4, p0, Lcom/android/server/NotificationManagerService;->mYepLedStatus:Lcom/android/server/NotificationManagerService$Status;
...
.method static synthetic access$1300(Lcom/android/server/NotificationManagerService;)Z
    ...
    .prologue
    .line 101
    iget-boolean v0, p0, Lcom/android/server/NotificationManagerService;->mIsYepLed:Z
...
.method static synthetic access$1400(Lcom/android/server/NotificationManagerService;)V
    ...
    .prologue
    .line 101
    invoke-direct {p0}, Lcom/android/server/NotificationManagerService;->updateYepLightsLocked()V
...
.method static synthetic access$1600(Lcom/android/server/NotificationManagerService;)Ljava/util/HashSet;
    .locals 1
    .parameter "x0"
...
.method private cancelNotification(Ljava/lang/String;Ljava/lang/String;IIIZI)V
    ...
    .line 2128
    iget-boolean v2, p0, Lcom/android/server/NotificationManagerService;->mIsYepLed:Z
...
.method private cancelNotificationLocked(Lcom/android/server/NotificationManagerService$NotificationRecord;Z)V
    ...
    .line 2089
    iget-object v4, p0, Lcom/android/server/NotificationManagerService;->mYepLights:Ljava/util/ArrayList;
...
.method private updateYepLightsLocked()V
    .locals 9
    ...
    .line 2323
    sget-object v0, Lcom/android/server/NotificationManagerService$Status;->STATE_IDLE:Lcom/android/server/NotificationManagerService$Status;

    .line 2324
    .local v0, LedStatus:Lcom/android/server/NotificationManagerService$Status;
    const/4 v5, 0x0

    iput-object v5, p0, Lcom/android/server/NotificationManagerService;->mYepLedNotification:Lcom/android/server/NotificationManagerService$NotificationRecord;
    ...
    .line 2331
    :cond_0
    iget-object v5, p0, Lcom/android/server/NotificationManagerService;->mYepLights:Ljava/util/ArrayList;
    ...
    .line 2335
    sget-object v0, Lcom/android/server/NotificationManagerService$Status;->STATE_MISSCALL:Lcom/android/server/NotificationManagerService$Status;

    .line 2336
    const-string v5, "tian"

    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6}, Ljava/lang/StringBuilder;-><init>()V

    const-string v7, "mYepLedNotification.pkg.all ="

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    iget-object v7, p0, Lcom/android/server/NotificationManagerService;->mYepLedNotification:Lcom/android/server/NotificationManagerService$NotificationRecord;
    ...
    .line 2339
    :cond_2
    iget-object v5, p0, Lcom/android/server/NotificationManagerService;->mYepLedNotification:Lcom/android/server/NotificationManagerService$NotificationRecord;
    ...
    invoke-virtual {v5}, Lcom/android/server/NotificationManagerService$NotificationRecord;->getFlags()I
    ...
    .line 2351
    sget-object v0, Lcom/android/server/NotificationManagerService$Status;->STATE_INFO:Lcom/android/server/NotificationManagerService$Status;
    ...
    const-string v7, "LedStatus mYepLedNotification.pkg ="
    ...
    const-string v7, "LedStatus ="

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    invoke-virtual {v0}, Lcom/android/server/NotificationManagerService$Status;->ordinal()I
    ...
    const v6, #android:integer@config_notificationsInfoLedARGB#t
    ...
    const v6, #android:integer@config_notificationsInfoLedOn#t
    ...
    const v6, #android:integer@config_notificationsInfoCallLedOff#t
    ...
    invoke-virtual {v5, v2, v8, v4, v3}, Lcom/android/server/LightsService$Light;->setFlashing(IIII)V
    ...
    const v6, #android:integer@config_notificationsMissCallLedARGB#t
    ...
    const v6, #android:integer@config_notificationsMissCallLedOn#t
    ...
    const v6, #android:integer@config_notificationsMissCallLedOff#t
...
.method cancelAll(I)V
    ...
    :cond_2
    :try_start_1
    iget-boolean v3, p0, Lcom/android/server/NotificationManagerService;->mIsYepLed:Z
...
.method cancelAllNotificationsInt(Ljava/lang/String;IIZI)Z
    ...
    .line 2191
    :try_start_1
    iget-boolean v4, p0, Lcom/android/server/NotificationManagerService;->mIsYepLed:Z
...
.method public enqueueNotificationInternal(Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;ILandroid/app/Notification;[II)V
    ...
    iget-boolean v6, v0, Lcom/android/server/NotificationManagerService;->mIsYepLed:Z
    ...
    iget-object v6, v0, Lcom/android/server/NotificationManagerService;->mYepLights:Ljava/util/ArrayList;
    ...
    iget-object v7, v0, Lcom/android/server/NotificationManagerService;->mYepLights:Ljava/util/ArrayList;
    ...
    .line 1994
    :cond_3c
    invoke-direct/range {p0 .. p0}, Lcom/android/server/NotificationManagerService;->updateYepLightsLocked()V
