...
.method public constructor <init>(Landroid/content/Context;Landroid/os/INetworkManagementService;Landroid/net/INetworkStatsService;Landroid/net/IConnectivityManager;Landroid/os/Looper;)V
    ...
    iput-object v1, p0, Lcom/android/server/connectivity/Tethering;->mLocaleReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-object v2, p0, Lcom/android/server/connectivity/Tethering;->mLocaleReceiver:Landroid/content/BroadcastReceiver;
...
.method static synthetic access$100(Lcom/android/server/connectivity/Tethering;)V
    .locals 0
    .parameter "x0"

    .prologue
    .line 75
    invoke-direct {p0}, Lcom/android/server/connectivity/Tethering;->showLocalChangedTetherNotification()V
...
.method private showLocalChangedTetherNotification()V
    .locals 16
    ...
    iget-object v12, v0, Lcom/android/server/connectivity/Tethering;->mConnService:Landroid/net/IConnectivityManager;

    invoke-interface {v12}, Landroid/net/IConnectivityManager;->isTetheringSupported()Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v14, "showLocalChangedTetherNotification "
