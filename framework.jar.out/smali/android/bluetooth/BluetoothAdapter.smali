...
.method public closeProfileProxy(ILandroid/bluetooth/BluetoothProfile;)V
    ...
    .line 1220
    check-cast v8, Landroid/bluetooth/BluetoothSap;

    .line 1221
    .local v8, sap:Landroid/bluetooth/BluetoothSap;
    invoke-virtual {v8}, Landroid/bluetooth/BluetoothSap;->close()V
...
.method public getProfileProxy(Landroid/content/Context;Landroid/bluetooth/BluetoothProfile$ServiceListener;I)Z
    ...
    .line 1175
    new-instance v6, Landroid/bluetooth/BluetoothSap;

    invoke-direct {v6, p1, p2}, Landroid/bluetooth/BluetoothSap;-><init>(Landroid/content/Context;Landroid/bluetooth/BluetoothProfile$ServiceListener;)V

    .line 1176
    .local v6, sap:Landroid/bluetooth/BluetoothSap;
    goto :goto_0

    .line 1177
    .end local v6           #sap:Landroid/bluetooth/BluetoothSap;
    :cond_6
    const/16 v9, 0x15
